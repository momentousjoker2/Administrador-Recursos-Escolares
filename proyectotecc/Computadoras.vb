...
Public Class Computadoras
    ...
    Private Sub btnRegistrar_Click(sender As Object, e As EventArgs) Handles btnRegistrar.Click
        ...
        Catch ex As Exception
            ...
            bitacora("Computadora - Registar    ", ex)
    ...
    Private Sub actualizar()
        Try
            ...
            lector.Close()
        Catch ex As Exception
            bitacora("Computadora - update    ", ex)
    ...
    Private Sub colocar(fila As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            bitacora("Computadora - Colocar    ", ex)
    ...
    Private Sub cboNombreRecursos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboNombreRecursos.SelectedIndexChanged
        Try
            ...
            lector.Close()
        Catch ex As Exception
            bitacora("Computadora - ComboNombre    ", ex)
